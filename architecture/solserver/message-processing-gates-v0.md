# Message Processing Gates v0

This document describes the gate-based architecture for processing user turns in SolMobile and SolServer.
...
flowchart TD
  ...
  D --> E[3 Sentinel Gate rules-first\n- domain/topic cues\n- escalation rules\n=> tier 0..3\n=> signals]
